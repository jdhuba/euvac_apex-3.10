...
!  integer,parameter :: nlat=101, nlon=1+24*4
  ...
  open(unit=101,file='phi_weimer.inp',form='unformatted')
  open(unit=102,file='fac_weimer.inp',form='unformatted')
  open(unit=103,file='phi_pole.inp',form='unformatted')
...
!      print *,i,mlon(i),mlt(i)
    ...
    !  close(101)
     ...
     write(103) epot_pole * 1.e3 / 300.  ! convert to statvolt/cm for sami3
     write(102) hrutw
     write(102) fac_weimer
